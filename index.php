...
.header {
    ...
    align-items: center;
    background-color: lightblue; /* Turquoise background */
    padding: 10px 20px;
    position: fixed;
    width: 100%;
    top: 0;
...
.navbar a {
    ...
    margin: 0 15px;
    font-size: 1rem;
    line-height: 50px; /* Center items vertically */
...
<section class="home" id="home">
    ...
    <div class="content">
        ...
        <p> The TARUMT Voting System is designed to empower students to elect the next Malaysia President using a secure, efficient, and transparent voting process. </p>
...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="content">
            ...
            <p>The TARUMT Voting System enables students to securely and efficiently vote for the next Malaysia President.</p>
            <p>Featuring fingerprint biometric verification, scheduled voting, and real-time result updates, it ensures a fair, transparent, and modern election process for all TARUMT students.</p>
...
<section class="rules" id="rule">
    ...
    <div class="box-container">
        ...
        <img src="image/rule1.png" style=" border-radius: 4px; padding: 5px; width: 220px;" alt="TARUMT Logo">
            ...
            <p>If you are 21 years old or older, register as a voter at any Election Commission (EC) office or post office.</p>
            <a href="#" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
        </div>
        ...
        <img src="image/rule3.png" style=" border-radius: 4px; padding: 5px; width: 220px;" alt="TARUMT Logo">
            ...
            <p>After parliament is dissolved, check your designated polling station on the Election Commission's website.</p>
            <a href="#" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
        </div>
        ...
        <img src="image/rule5.png" style=" border-radius: 4px; padding: 5px; width: 220px;" alt="TARUMT Logo">
            ...
            <p>Upon entering the polling station, polling clerks will record your name and IC number and mark you off the electoral list.</p>
            <a href="#" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
        </div>
        ...
        <img src="image/rule6.png" style=" border-radius: 4px; padding: 5px; width: 220px;" alt="TARUMT Logo">
            ...
            <p>A second officer will check your hands for marks then dip your finger in indelible ink to confirm you've voted.</p>
            <a href="#" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
        </div>
        ...
        <img src="image/rule7.png" style=" border-radius: 4px; padding: 5px; width: 220px;" alt="TARUMT Logo">
            ...
            <p>In the voting booth, mark "X" next to your chosen candidate. Avoid marking outside the box to ensure your vote is valid.</p>
            <a href="#" class="btn"> learn more <span class="fas fa-chevron-right"></span> </a>
        </div>
